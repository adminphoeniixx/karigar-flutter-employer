        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              const Spacer(),
              const _Feature(LucideIcons.plus, 'Post jobs in under a minute'),
              const _Feature(
              ...
              const Center(
                child: Text.rich(
                  TextSpan(
                    children: [
                      TextSpan(text: 'For employers · Looking for work? '),
                      TextSpan(
                  ...
                  style: TextStyle(color: Color(0xD9FFFFFF), fontSize: 12.5),
                ),
              ),
            ],
          ),
